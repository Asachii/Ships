...
Ship2x1::Ship2x1()
{
	_texture1.loadFromFile("Graphics/PatrolBoat2.png");
	_texture2.loadFromFile("Graphics/PatrolBoat2_wrong.png");
...
void Ship2x1::draw(sf::RenderWindow *window)
{
...
void Ship2x1::move(sf::Event *event)
{
...
void Ship2x1::check_err(sf::Sprite sprite)
{
